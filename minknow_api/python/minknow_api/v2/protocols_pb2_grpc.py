...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in minknow_api/v2/protocols_pb2_grpc.py depends on'
...
class ProtocolsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.list_protocol_group_ids = channel.unary_unary(
                '/minknow_api.v2.protocol.ProtocolsService/list_protocol_group_ids',
                request_serializer=minknow__api_dot_v2_dot_protocols__pb2.ListGroupIdsRequest.SerializeToString,
...
def add_ProtocolsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'list_protocol_group_ids': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=minknow__api_dot_v2_dot_protocols__pb2.ListGroupIdsRequest.FromString,
...
class ProtocolsService(object):
    ...
    def list_protocol_group_ids(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/minknow_api.v2.protocol.ProtocolsService/list_protocol_group_ids',
            minknow__api_dot_v2_dot_protocols__pb2.ListGroupIdsRequest.SerializeToString,
